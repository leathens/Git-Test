 ...
 * @author Anna Hensley 
 * @date 2024-09-11
 * @brief Quiz 0.5 Redo - Problem 3
 * 
 * This program was copied from Quiz 0.5 - Problem 1. I did make some edits and tweaks to make it fall in accordance with what was provided in the guidelines. I editted this to make the array dynamic rather than static. I also asked the user for the size of the array/max size. It also ensures that no more than the max size of the array can be read from the file. 
 */
 ...
 *
 * @param const int* array This constant array contains integers/values that we read and stored from the file chosen.
